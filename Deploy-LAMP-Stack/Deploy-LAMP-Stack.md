...
1. Check all the namespaces and pods.
...
3. Create main yaml file. (config map, deployment, service)
```
vi lamp-dev.yaml
...
4. Apply the yaml file & check the pods are running.
```
kubectl apply -f lamp-dev.yaml
kubectl get pods

```
5. Change the values in /tmp/index.php file. 
```
vi /tmp/index.php
...
```
6. Copy this index.php file httpd container.
```
kubectl get pods 

kubectl cp /tmp/index.php lamp-wp-57cf8d4cf-kd44f:/app -c httpd-php-container
```
