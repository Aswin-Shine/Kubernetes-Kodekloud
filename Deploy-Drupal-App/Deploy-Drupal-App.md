...
1. Check the namespaces & pods running.
...
3. Create persisten volumne yaml file.
...
4. Create drupal deployment yaml file.
...
```
kubectl apply -f drupal-secrets.yaml
kubectl apply -f drupa-pvc.yaml
kubectl apply -f drupal-dev.yaml
```
