...
4. Apply this yaml file and check pods are running or not

```
kubectl apply -f nginx-phpfpm-dev.yaml
kubectl get pods
```

5. Copy data to nginx-container

```
kubectl cp /opt/index.php nginx-phpfpm:/var/www/html/index.php -c nginx-container
```

6. Exec into container to check the file has copied
