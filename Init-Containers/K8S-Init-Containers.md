...
The initContainers should be named as ic-msg-nautilus, use image fedora with latest tag and use command '/bin/bash', '-c' and 'echo Init Done - Welcome to xFusionCorp Industries > /ic/blog'. The volume mount should be named as ic-volume-nautilus and mount path should be /ic.

Solution :

1. Check all the namespaces and pod running.
...
2. Create nautilus-deployment.yaml file
